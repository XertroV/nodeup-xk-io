...
parser.add_argument('--set-server-active', help='set a server id to be active', type=str, default='')
parser.add_argument('--undestroy-and-recreate', help='processed uid to undestroy and recreate', type=str, default='')
...
if args.set_server_active != '':
    print('Setting %s active' % args.set_server_active)
    active_servers.add(args.set_server_active)
